...
export default function PersonalDataScreen() {
  ...
  const [fullName, setFullName] = useState('Jenny Wilson');
  const [email, setEmail] = useState('wilson@09gail.com');
  ...
  const [dob, setDob] = useState<string | null>('2000-11-24');
    ...
    <SafeAreaView style={[s.safe, { backgroundColor: colors.background }]} edges={['top']}>
      <KeyboardAvoidingView
        ...
        <View style={s.header}>
          ...
          <Text style={[s.headerTitle, { color: colors.textPrimary }]}>Personal Data</Text>
