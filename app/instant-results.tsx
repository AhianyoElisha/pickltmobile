...
// ── Main screen ────────────────────────────────────────────────────────────
export default function InstantResultsScreen() {
  ...
  // Counts keyed as "Category:ItemName"
  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top', 'bottom']}>
      ...
      <ScrollView
          ...
          <View style={styles.locationPanel}>
            ...
            <View style={styles.locationTexts}>
              <Text style={styles.locationText} numberOfLines={1}>
                {params.fromName || 'Pick up location'}
              </Text>
              <View style={styles.locationDivider} />
              <Text style={styles.locationText} numberOfLines={1}>
                {params.toName || 'Drop off location'}
              </Text>
            </View>
          </View>
        </View>
        ...
        {/* Bottom padding for the fixed Next button */}
      ...
      <View style={styles.footer}>
        <TouchableOpacity
          ...
          activeOpacity={0.85}
          onPress={() => {
            // TODO: navigate to next step with all collected data
          }}>
