/**
 * Nav icons — exact SVG paths downloaded from the PickLT Figma file.
 * Each icon accepts a `color` prop so active/inactive tinting is handled
 * by the parent BottomNavBar.
 *
 * Source node: 2034-2914 (Navbar component)
 * Assets: assets/icons/nav-*.svg
 */
...
// ── Home (vuesax/bold/home) ────────────────────────────────────────────────
export function NavHomeIcon({ color, size = 24 }: NavIconProps) {
  return (
...
// ── Moves (vuesax/bold/truck-fast) ────────────────────────────────────────
export function NavMovesIcon({ color, size = 24 }: NavIconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <G id="truck-fast">
        <Path
...
// ── Scheduled (vuesax/bold/bookmark) ─────────────────────────────────────
export function NavScheduledIcon({ color, size = 24 }: NavIconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <G id="bookmark">
        {/* Outer card — fills with active color */}
        <Path
          d="M9 22H15C20 22 22 20 22 15V9C22 4 20 2 15 2H9C4 2 2 4 2 9V15C2 20 4 22 9 22Z"
          fill={color}
        />
        {/* Inner ribbon — white cutout */}
        <Path
...
// ── Profile (vuesax/bold/profile) ────────────────────────────────────────
export function NavProfileIcon({ color, size = 24 }: NavIconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <G id="profile">
        <Path
