  ...
  return (
    <TouchableOpacity style={sc.row} onPress={onToggle} activeOpacity={0.8}>
      ...
      <View style={sc.textCol}>
        ...
        <Text style={sc.description}>{description}</Text>
      </View>
    </TouchableOpacity>
  );
}
...
const sc = StyleSheet.create({
  ...
  title:       { fontFamily: FontFamily.regular, fontSize: 16, lineHeight: 25.6, color: Colors.textPrimary },
  description: { fontFamily: FontFamily.regular, fontSize: 14, lineHeight: 19.6, color: Colors.textSecondary },
});
...
export function StepAdditionalServices() {
  ...
  return (
    <View style={s.container}>
      {/* ── Photos section ─────────────────────────────────────────────── */}
      <Text style={s.pageHeading}>Add Inventory Photos</Text>
      ...
      <View style={s.servicesSection}>
        <Text style={s.servicesTitle}>Additional Services</Text>
        <Text style={s.servicesSubtitle}>These are standard offerings from German movers.</Text>
...
const s = StyleSheet.create({
  ...
  photoSection: { gap: 8 },
  sectionLabel: {
    fontFamily: FontFamily.medium, fontSize: 14, lineHeight: 19.6, color: Colors.textPrimary,
  },
